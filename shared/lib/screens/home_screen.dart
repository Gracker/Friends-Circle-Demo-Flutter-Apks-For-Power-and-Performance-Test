...
const String _flutterVersion = String.fromEnvironment('FLUTTER_VERSION', defaultValue: '3.19');
const String _renderMode = String.fromEnvironment('RENDER_MODE', defaultValue: 'SurfaceView');
const String _packageName = String.fromEnvironment('PACKAGE_NAME', defaultValue: 'com.example.friendscircle.v19');

const bool _isTextureView = _renderMode == 'TextureView';
const Color _badgeColor = _isTextureView ? Color(0xFFE91E63) : Color(0xFF1976D2);

/// Home screen for selecting different load levels
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: const Text(
                  '13 Load Types | $_renderMode Rendering',
                  style: TextStyle(
                    fontSize: 12,
                    color: _badgeColor,
                  ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildInfoRow('PostFrame Load', 'Executes after frame rendering, simulates between-frame computation'),
            ...
            Container(
              ...
              child: const Text(
                'adb shell am start -n $_packageName/.MainActivity -e "load" "build_heavy"',
                style: TextStyle(
                  fontSize: 11,
